...
app.include_router(issue_router, tags=["Issues"])
app.include_router(issue_type_router, tags=["Issue Types"])
app.include_router(project_router, tags=["Projects"])
app.include_router(sprint_router, tags=["Sprints"])
app.include_router(user_project_router, tags=["User Projects"])
app.include_router(membership_plan_router, tags=["Membership Plans"])
app.include_router(payment_info_router, tags=["Payment Info"])
app.include_router(recover_password_router, tags=["Recover Password"])
